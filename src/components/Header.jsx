      ...
      {user && (
        <div className="flex items-center  gap-3 rounded">
          <button
            ...
            className="mb-3 relative inline-flex items-center justify-start inline-block px-3 py-1 overflow-hidden font-medium transition-all bg-blue-600 rounded-full hover:bg-white group"
          >
